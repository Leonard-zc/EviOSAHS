...
cmd=(
  ...
  --experiment-id F5_A2_wo_react
  --experiment-id F5_A3_wo_structured_clinical
  --experiment-id F5_A4_wo_evidence_strength
  --experiment-id F5_A5_wo_balanced_final
  --experiment-id F5_A6_wo_7q_decomposition
  --mode execute
)
